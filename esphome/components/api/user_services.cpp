...
template<> std::vector<long> get_execute_arg_value<std::vector<long>>(const ExecuteServiceArgument &arg) {
...
template<> enums::ServiceArgType to_service_arg_type<long>() { return enums::SERVICE_ARG_TYPE_INT; }
...
template<> enums::ServiceArgType to_service_arg_type<std::vector<long>>() { return enums::SERVICE_ARG_TYPE_INT_ARRAY; }
