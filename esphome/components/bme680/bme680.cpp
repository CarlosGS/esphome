...
float BME680Component::calc_gas_resistance_(uint16_t gas_res_adc, uint8_t gas_range)
{
...
uint32_t lookupTable2[16] = { UINT32_C(4096000000), UINT32_C(2048000000), UINT32_C(1024000000), UINT32_C(512000000),
	...
	var1 = (int64_t) ((1340 + (5 * (int64_t) this->calibration_.range_sw_err)) * ((int64_t) lookupTable1[gas_range])) / 65536;
