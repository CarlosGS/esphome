...
IGNORE_INVERTED = "ignore_inverted"
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(IGNORE_INVERTED, default=False): cv.boolean,
...
async def to_code(config):
    ...
    if IGNORE_INVERTED in config:
        cg.add(var.set_ignore_inverted(config[IGNORE_INVERTED]))
